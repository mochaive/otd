...
OTD is built on four principles. Everything else in the framework follows from them.
...
### Four failure modes a productivity system has to guard against
...
- **Approval-theater failure** — The decision points exist, but they stop deciding. Work returns faster than you can judge it, so approving becomes a reflex. You are formally in control and practically not. Long-term cost: the illusion of agency, which is worse than its absence because it hides the drift. Diagnostic: your approval rate sits near 100%.
...
**You're prone to Approval-theater failure if:**

- You delegate to AI often, and results come back faster than you read them
- You cannot remember the last time you rejected something that came back
- You approve in batches to clear the queue rather than to make a judgment
- You'd have to check the log to know what changed in your system yesterday

This profile is new — it barely existed before delegation became cheap. The other three are about *choosing what to do*; this one is about *accepting what came back*. **Recommended cadence:** lower your Review budget until judging feels real again, narrow how many agents can write, and put friction on returns that change or remove existing work. Approving less per day is the fix, not approving faster.
...
AI in OTD is an executor. It can populate Today, suggest swaps, surface Stuck Signals, and carry Delegate / Await / Review cycles. What it cannot do is choose your themes, your Goals, or what closes when you activate something new.

What comes back from AI enters through Review, never directly (Principle 4). Filling your day is delegable. Accepting the result is not.
...
## 4. Nothing lands unreviewed.

Work that comes back from Await enters through Review. It is never applied on arrival.

### Why delegation needs a return gate

Principles 1 through 3 cover input, agency, and the ceiling of the active set. They share an assumption: what you delegated comes back the way you remember sending it, at a pace you can absorb.

With people that assumption mostly holds. A colleague replies; you read the reply. Delegation is slow and low-volume, so the return takes care of itself.

With AI it does not hold. One agent can return a dozen results in minutes, and most tools apply those results the moment they arrive. The work lands in your system without passing through you.

That breaks Principle 1 from the far end. You still hold everything — but you no longer know which parts you chose. A system you can't distinguish your own decisions in is not a trusted system.

### The gate

- **Await → Review → in.** There is no other path for returned work.
- **Review is a decision:** accept, reject, or send back.
- **Reading needs no gate.** Anything that changes your system does.
- **Rejections leave a trace.** Nothing disappears silently, and nothing arrives silently.

### Actor matters

Await and Review carry an actor: **human, agent, or rule** (see [Mode](/mode)). All three return through the same gate, but they fail differently:

- **Human** — slow, few, easy to forget. The risk is losing track.
- **Agent** — fast, many, plausible. The risk is volume outrunning judgment.
- **Rule** — invisible while it works. The risk is forgetting you wrote it. A rule is only legitimate while you can read it back as your own sentence.

### Review has a budget

A gate with no budget becomes a second Inbox — the exact failure Principle 1 exists to prevent, arriving through the back door.

Cap how much you review in a day. When the cap is reached, **the machine waits, not you**: agents stop being able to hand work back until you have room. Unreviewed items age out and surface as Stuck Signals rather than piling up.

### What the system cannot promise

Await records that you handed something off. It does not verify that the work was done. A returned result is a **claim**, and Review is where you weigh the claim. A framework that pretends otherwise turns delegation into faith.

### Why this is a principle and not a feature

A tool can implement the gate, and a good tool should. But the gate is worthless if approving is cheaper than thinking — see **Approval-theater failure** in Principle 2. What makes this a principle is the standard it sets: *the final decision is human, at the moment work enters your system.* A tool can hold the door. Only you can decide what walks through.
...
Principle 4 creates the seal: nothing enters the system without your decision, no matter who or what produced it.

Together, they produce a specific outcome: you're never surprised by what you're working on, you never feel like you're just reacting, and the system doesn't quietly bloat into a backlog you can't finish. Principle 1 puts everything in. Principle 2 keeps you in the driver's seat without forcing daily ceremony. Principle 3 keeps the road inhabitable. Principle 4 keeps the road yours — as delegation gets cheaper, it is the principle that stops the system from filling with work you never chose.
