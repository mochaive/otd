...
Inbox는 모든 입력의 단일 진입점이다. 모든 태스크, 아이디어, 약속, 걱정(주의가 필요한 모든 것)이 먼저 Inbox로 간다. Area가 아니라. Flow가 아니라. Inbox다.
...
- **Inbox 하나.** 모든 것은 단일 지점을 통해 들어온다. 물건이 올 수 있는 곳이 다섯 곳(노트북, 앱 두 개, 이메일 수신함, 음성 메모)이라면, 항상 "뭔가 놓친 거 아닐까?"가 따라온다. Inbox 하나가 그 불안을 없앤다.
...
이 각각이 잠재적 Action이다. OTD에서 이 모두는 출처와 무관하게 Inbox를 통해 들어온다. 원칙은 GTD와 같다; 유입의 양과 다양성이 더 클 뿐이다.
