...
- **Area, Project, Flow, Action**을 담을 것 (같은 앱이나 다른 앱)
...
**Weekly Review** — 주 1회, 30~60분. 전체 시스템 감사: Inbox 비우기, 모든 Area·Project·Flow·Await 항목·Someday 검토. (전체 체크리스트는 [점검](/ko/review)을 참조.)
