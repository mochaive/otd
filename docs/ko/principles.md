...
- **승인 형식화 실패** — 결정 지점은 있는데 결정이 사라진다. 돌아오는 일이 판단하는 속도보다 빨라서, 승인이 반사 행동이 된다. 형식상으로는 네가 통제하고 실질적으로는 아니다. 장기 비용: 주체성의 착각 — 없는 것보다 나쁘다, 표류를 가려주기 때문이다. 진단: 승인율이 100%에 붙어 있다.
