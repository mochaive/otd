...
*"Read Shape Up"* → Wishlist. She's interested but not committing. There's no aging pressure if it sits there for a year.
...
She starts with the ones she can batch: the two quick admin items (book appointment, submit expenses) take 15 minutes together. Then focused work on the three project Actions.
