...
Stage 5: Work through Today by Mode.

---

## The execution loop

Execution in OTD is simple in principle: open Today, work through it in Mode order, close it when it's empty.

```
Review items → Delegate items → Do items
```

When Today is empty, you're done for the day.
...
- Scope: what specifically to do
- Constraints: format, length, deadline, style
- Output: what a good result looks like

For AI delegation specifically, the quality of your instructions directly determines the quality of the Review that comes back. A poorly articulated Delegate creates a poor Review, which requires re-delegation, which extends the cycle. Invest 2 extra minutes in clarity now to save 30 minutes of rework later.

After delegating, the Action moves to Await in your Flow. You've done your part; the ball is in their court.

### Do last

Direct execution. Full focus.

By the time you get to Do items, you've already set other Flows in motion:
- Review items unblocked waiting Flows
- Delegate items are with your delegates, doing work in parallel

Now you can work on Do items without the nagging sense that you've left something blocked. Everything that could be moving is moving. Give the Do work your full attention.
...
## Mode-based batching in practice

A realistic Today might look like:

**Review (start here):**
- [Review] Read AI draft of market analysis → approve or re-delegate
- [Review] Check contractor's design mockup → approve or revise

**Delegate (next):**
- [Delegate] Ask AI to research competitor pricing
- [Delegate] Send legal doc to attorney for review
- [Delegate] Ask colleague to confirm meeting time

**Do (then):**
- [Do] Write intro section of proposal
- [Do] Update project timeline
- [Do] Book follow-up call with client

This is nine items. Two Reviews take maybe 20 minutes. Three Delegates take maybe 15 minutes. Three Do items take... however long they take.
...
Today will be disrupted. Meetings run long. Emergencies arrive. Someone drops an urgent request.
